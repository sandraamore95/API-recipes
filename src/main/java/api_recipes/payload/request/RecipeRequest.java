...
public class RecipeRequest {
    ...
    @Size(min = 10, max = 1000, message = "La descripción debe tener entre 10 y 100 caracteres")
    private String description;

    @NotBlank(message = "El método de preparación es obligatorio")
    @Size(min = 5, max = 1000, message = "El método de preparación debe tener entre 5 y 100 caracteres")
